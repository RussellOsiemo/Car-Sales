...
<body> 
    ...
    <section>
    <center><h3>Hi, <b><?php echo htmlspecialchars($_SESSION["username"]); ?></b>. Welcome to our site.</h3><br></center>
    ...
    <div>
    <p>
        <button><a href="reset.php" class="newbutton">Reset Your Password</a></button>
        <button><a href="logout.php" class="newbutton">Sign Out of Your Account</a></button>
    </p>
    </div>
</section>
<!---Cars---->
